    ...
    <div className="relative">
      ...
      <div className="absolute top-0 left-0 right-0 h-[686px] w-full">
        <div className="relative h-full w-full">
          <div className="flex max-w-[85rem] mx-auto items-center justify-between w-full h-full">
            <div className=" md:flex-1">
              <div className=" max-w-[506px] mx-6">
                <h1 className=" font-medium text-[51px] leading-[78px] mb-5 text-white">
                  We Build scalable and secure data solutions
                </h1>
            ...
            <div className="hidden md:flex-1 md:flex justify-end">
              <p className=" max-w-[399px] border-l-[7px] border-secondary p-[9px] text-xs text-white">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Erat
