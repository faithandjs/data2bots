      ...
      <Container>
        <div className=" flex flex-col relative justify-center md:flex-row md:items-center lg:gap-12 md:gap-6">
          <div className="flex-1 md:mx-0 mt-6 text-[#727891] relative mb-20 md:mb-0">
            ...
            <p
              className={
                "text-sm md:text-[21px] md:ml-16 mb-[18px] leading-[31.5px] text-[#727891]"
              }
            >
              Are you a data professional or enthusiast looking to join a team
              of innovative minds to spur a change in digital transformation?
              <br />
              <br />
              We build secure and scalable data solutions in the cloud, helping
              organisations make informed decisions off their data.
              <br />
              <br />
              We provide a remote real-life working environment designed for
              innovative thinkers.
            </p>
          </div>
