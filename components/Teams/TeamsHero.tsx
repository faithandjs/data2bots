  ...
  return (
    <div className="relative mt-[80px] md:mt-[89px] mb-64">
      ...
      <div className="absolute top-0 left-0 right-0 h-[583px] w-full">
        ...
        <div className="relative h-full w-full bg-[rgba(255,161,49,0.58)] rounded-full">
        </div>
      </div>
      {/* circular design end */}
            ...
            <div className="relative md:flex-1 md:flex justify-start mx-6">
                 ...
                 helping businesses make informed decisions off their data. Our solutions 
                 are driven towards identifying organizational data challenges, 
                 designing strategi
                </p> 
            </div>
          </div>
